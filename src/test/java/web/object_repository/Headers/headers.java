...
public class headers {
    ...
    public void click_and_verify_about_us_link(String text_to_enter) {
    ...
    public void click_and_verify_services_link(String text_to_enter) {
        wait.wait_for_second(2);
    ...
    public void click_and_verify_branches_link(String text_to_enter) {
        wait.wait_for_second(2);
    ...
    public void click_and_verify_promotions_link(String text_to_enter) {
        wait.wait_for_second(2);
    ...
    public void click_and_verify_contact_us_link(String text_to_enter) {
        wait.wait_for_second(2);
    ...
    public void click_and_verify_remit_online_link(String text_to_enter) {
        wait.wait_for_second(2);
    ...
    public void click_and_verify_news_link(String text_to_enter) {
        wait.wait_for_second(2);
    ...
    public void click_and_verify_faq_link(String text_to_enter) {
        wait.wait_for_second(2);
    ...
    public void click_and_verify_arabic_link(String text_to_enter) {
        wait.wait_for_second(2);
