...
public class remit_online {
    ...
    public void verify_validation_message(String validation_text){
        wait.wait_for_second(2);
        Assert.assertEquals(element.get_element_text("length_of_civil_id_should_be_12_digits_on_remit_online"),validation_text);
    }
